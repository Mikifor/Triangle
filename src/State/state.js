let store = {
    ...
    counts() {
        ...
        if (this._state.Angles[0][0].block === false && this._state.Sides[0][0].block === false) { return alert("Сферический треугольник единственным образом определяется (с точностью до преобразования симметрии): тремя сторонами, тремя углами, двумя сторонами и заключенным между ними углом, стороной и двумя прилежащими к ней углами.") }
        if (this._state.Angles[1][0].block === false && this._state.Sides[1][0].block === false) { return alert("Сферический треугольник единственным образом определяется (с точностью до преобразования симметрии): тремя сторонами, тремя углами, двумя сторонами и заключенным между ними углом, стороной и двумя прилежащими к ней углами.") }
        if (this._state.Angles[2][0].block === false && this._state.Sides[2][0].block === false) { return alert("Сферический треугольник единственным образом определяется (с точностью до преобразования симметрии): тремя сторонами, тремя углами, двумя сторонами и заключенным между ними углом, стороной и двумя прилежащими к ней углами.") }
